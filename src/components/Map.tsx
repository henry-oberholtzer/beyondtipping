...
export const Map = () => {
    ...
    markers.forEach(marker => {
        // Subtract 0.00064 from the 0th index of geocode array
        marker.geocode[0] -= 0.00064;
    });
                    ...
                    {markers.map(marker => (
                        ...
                        <Marker position={marker.geocode} icon={customIcon}>
                            <Popup>
                                <div className="popup">
                                    <h2>{marker.popUp}</h2>
                                    <img src={marker.imageUrl} alt="restaurant" />
                                    <div className="addressAndFeeType">
                                        <h3>{typeData[marker.typeId].amount} {typeData[marker.typeId].name}</h3>
                                        <p>{marker.address}</p>
                                    </div>
                                    <div className="links">
                                        <a href={marker.websiteUrl} target="_blank" rel="noopener noreferrer">Website</a>
                                        <a href={`https://www.google.com/maps/dir/?api=1&destination=${marker.address}`} target="_blank" rel="noopener noreferrer">Directions</a>
                                    </div>
                                </div>
                            </Popup>
                        </Marker>
